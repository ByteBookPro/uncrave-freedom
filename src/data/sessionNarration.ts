// Detailed narration scripts for each day's modules
export const sessionNarration: Record<string, string> = {
  // Day 1 - A New Journey Begins
  'd1m1': `Hello and welcome! Today marks Day 1 of your journey to becoming completely smoke-free. Take a moment to appreciate this decision – you've taken the first step toward a healthier, happier you. Congratulations!
